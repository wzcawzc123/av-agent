...
SCENE_QUESTIONS = [
    ...
    (
        ...
        [
            ("seats", "体育馆观众席大概多少座？"),
            ("display", "是否需要计时计分显示屏/计分牌？大概尺寸？"),
            ("lighting", "是否需要比赛/演出灯光？"),
        ],
    ),
    (
        ("宴会厅", "婚礼", "酒楼"),
        [
            ("seats", "宴会厅容纳多少桌/多少人？"),
            ("display", "显示用 LED 还是投影？大概尺寸？"),
            ("lighting", "是否需要婚宴灯光（染色/追光）？"),
        ],
    ),
    (
        ("演播厅", "录播", "直播间"),
        [
            ("display", "显示/提词用什么设备？"),
            ("videoconf", "是否需要直播推流/远程连线？"),
            ("signal_sources", "信号源路数（摄像机/电脑/播放器）？"),
        ],
    ),
    (
        ("指挥中心", "监控", "调度"),
